...
public class ClassGeneratorUtil implements Opcodes {
    ...
    public byte[] generateClass() {
        ...
        cw.visit(52 /*V1_8*/, classMods, fqClassName, signature, superClassName, interfaceNames);
    ...
    private void generateEnumSupport(String fqClassName, String className, String classDescript, ClassWriter cw) {
        ...
        cv.visitMethodInsn(INVOKEVIRTUAL, "bsh/This", "enumValues", "()[Ljava/lang/Object;");
        ...
        cv.visitMethodInsn(INVOKESTATIC, "java/lang/Enum", "valueOf", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;");
        ...
        cv.visitMethodInsn(INVOKESTATIC, "bsh/This", "initInstance", "(Lbsh/GeneratedClass;Ljava/lang/String;[Ljava/lang/Object;)V");
        cv.visitInsn(RETURN);
        cv.visitMaxs(0, 0);
    }
    ...
    private void generateEnumStaticInit(String fqClassName, String classDescript, MethodVisitor cv) {
        ...
        for ( Variable var : vars ) if ( var.hasModifier("enum") ) {
            ...
            cv.visitMethodInsn(INVOKESPECIAL, fqClassName, "<init>", "(Ljava/lang/String;I)V");
    ...
    private void generateMethod(String className, String fqClassName, String methodName, String returnType, String[] paramTypes, int modifiers, ClassWriter cw) {
        ...
        cv.visitMethodInsn(INVOKEVIRTUAL, "bsh/This", "invokeMethod", "(Ljava/lang/String;[Ljava/lang/Object;Z)Ljava/lang/Object;");
    ...
    void generateStaticInitializer(ClassWriter cw) {
        ...
        cv.visitMethodInsn(INVOKESTATIC, "bsh/This", "pullBshStatic", "(Ljava/lang/String;)Lbsh/This;");
        ...
        cv.visitMethodInsn(INVOKESTATIC, "bsh/This", "initStatic", "(Ljava/lang/Class;)V");
    ...
    void generateConstructorSwitch(int consIndex, int argsVar, int consArgsVar,
        ...
        cv.visitMethodInsn(INVOKESTATIC, "bsh/This", "getConstructorArgs", "(Ljava/lang/Class;Lbsh/This;[Ljava/lang/Object;I)" + "Lbsh/This$ConstructorArgs;");
