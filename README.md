...
abcl.compile.lisp:
     ...
     [java] ;  COMMON-LISP:CHAR= triggers autoloading of abcl.CharacterFunctions ...
...<SNIP>...
     [java] ; (IN-PACKAGE :SYSTEM)
     [java] ; (DOLIST (FS #) ...)
     [java] ; (IN-PACKAGE :CL)
     ...
     [java] ; (IN-PACKAGE :CL)
     [java] ; (DOLIST (SYSTEM::FS #) ...)
     [java] ;COMMON-LISP:DELETE-FILE triggers autoloading of abcl.delete_file ...
     [java] ; Autoloaded abcl.delete_file (0.0 seconds)
