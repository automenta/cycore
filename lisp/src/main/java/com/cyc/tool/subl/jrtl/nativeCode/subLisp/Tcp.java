        ...
        public synchronized void safeRun() {
            ...
            try {
                ...
                if (port100 == 1) {
                    ...
                    System.setIn(connectionSocket.getInputStream());
                    System.setOut(new PrintStream(connectionSocket.getOutputStream()));
                    System.setErr(new PrintStream(connectionSocket.getOutputStream()));
                } else {
