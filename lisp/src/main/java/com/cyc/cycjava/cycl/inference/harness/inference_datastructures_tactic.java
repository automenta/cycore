...
import static subl.Numbers.logxor;
 ...
 public static final String myName = "com.cyc.cycjava.cycl.inference.harness.inference_datastructures_tactic";
    ...
    public static final SubLObject print_tactic_alt(SubLObject v_object, SubLObject stream, SubLObject depth) {
        {
            ...
            if (NIL != com.cyc.cycjava.cycl.inference.harness.inference_datastructures_tactic.tactic_invalid_p(v_object)) {
            ...
            } else {
                {
                    ...
                    format(stream, $str_alt45$__a_TACTIC__a__a__a___a__a__, inference_datastructures_tactic.tactic_hl_module_name(v_object), inference_datastructures_problem_store.problem_store_suid(inference_datastructures_problem.problem_store(problem)), inference_datastructures_problem.problem_suid(problem), inference_datastructures_tactic.tactic_suid(v_object), (NIL != $leviathan_avoid_logical_tactic_productivity_computationP$.getDynamicValue(thread)) && (NIL != inference_worker.logical_tactic_p(v_object)) ? ((SubLObject) (NIL)) : inference_datastructures_tactic.tactic_productivity(v_object), inference_datastructures_tactic.tact_completeness(v_object));
                }
            }
            return NIL;
        }
    ...
    public static SubLObject print_tactic(final SubLObject v_object, final SubLObject stream, final SubLObject depth) {
        ...
        if (NIL != inference_datastructures_tactic.tactic_invalid_p(v_object)) {
            ...
            format(stream, inference_datastructures_tactic.$str54$__a_TACTIC__a__a__a___a__a__, inference_datastructures_tactic.tactic_hl_module_name(v_object), inference_datastructures_problem_store.problem_store_suid(inference_datastructures_problem.problem_store(problem)), inference_datastructures_problem.problem_suid(problem), inference_datastructures_tactic.tactic_suid(v_object), (NIL != inference_datastructures_tactic.$leviathan_avoid_logical_tactic_productivity_computationP$.getDynamicValue(thread)) && (NIL != inference_worker.logical_tactic_p(v_object)) ? NIL : inference_datastructures_tactic.tactic_productivity(v_object), inference_datastructures_tactic.tact_completeness(v_object));
        }
        return NIL;
    }
