...
import subl.*;
import subl.PrologSync.IPrologifiable;
...
import static subl.type.core.AbstractSubLSequence.EQL_TEST;
import static subl.type.core.AbstractSubLSequence.IDENTITY_UNARY_FUNC;

abstract public class SubLNil extends Symbol implements SubLList, SubLSymbol, SubLBoolean, IPrologifiable {

    /* (non-Javadoc)
     * @see subl.PrologSync.IPrologifiable#toProlog(java.util.List)
     */
    @Override
    ...
    @Deprecated final public static Nil NIL = Lisp.NIL;
    final private static SubLObject[] EMPTY_SUBL_OBJECT_ARRAY = new SubLObject[0];
    final private static List<SubLObject> EMPTY_LIST = Collections.unmodifiableList(new ArrayList<>(0));
