    ...
    implements abcl.protocol.Hashtable, LispHashTable
{
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#getRehashSize()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#getRehashThreshold()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#getSize()
	 */
    @Override
	public int getSize() {
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#getCount()
	 */
    @Override
	public int getCount() {
        return count;
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#gethash(abcl.LispObject)
	 */
    @Override
    ...
    // gethash key hash-table &optional default => value, present-p
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#gethash(abcl.LispObject, abcl.LispObject)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#gethash1(abcl.LispObject)
	 */
  //  @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#puthash(abcl.LispObject, abcl.LispObject)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#remhash(abcl.LispObject)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#getTestSymbol()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#get(abcl.LispObject)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#put(abcl.LispObject, abcl.LispObject)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#remove(abcl.LispObject)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#ENTRIES()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#getEntries()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see abcl.LispHashTable#MAPHASH(abcl.LispObject)
	 */
    @Override
