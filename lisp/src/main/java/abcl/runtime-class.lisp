...
(defconstant +abcl-java-object+ (make-jvm-class-name "abcl.JavaObject"))

(defun java::make-memory-class-loader (&optional (parent (java:get-current-classloader)))
  (java:jnew "abcl.MemoryClassLoader" parent))
...
(defconstant +abcl-lisp-integer-object+ (make-jvm-class-name "abcl.LispInteger"))
