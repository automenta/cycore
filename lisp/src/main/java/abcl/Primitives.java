...
//            }
	...
	private static final class pf_symbol_function extends Primitive {
		...
		public LispObject execute(LispObject arg) {
			...
			return function != null ? function : error(new UndefinedFunction(arg));
		}
	}
	...
	private static final class pf__class_layout extends Primitive {
		...
		@Override
		public LispObject execute(LispObject arg) {
			Layout layout = arg instanceof LispClass ? ((LispClass) arg).getClassLayout() : (Layout) ((StandardObject) arg).getInstanceSlotValue(StandardClass.symLayout);
	...
	private static final class pf_char_to_utf8 extends Primitive {
		...
		@Override
		public LispObject execute(LispObject arg) {
			final LispCharacter c = checkCharacter(arg);
