...
public class AbclScriptEngine extends AbstractScriptEngine implements Invocable, Compilable {
	...
	protected AbclScriptEngine() {
		...
		loadFromClasspath("/abcl/scripting/lisp/packages.lisp");
		loadFromClasspath("/abcl/scripting/lisp/abcl-script.lisp");
		loadFromClasspath("/abcl/scripting/lisp/config.lisp");
