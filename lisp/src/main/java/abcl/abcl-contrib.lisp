...
(defun boot-classloader ()
  (let ((boot-class (java:jclass "abcl.Main")))
     ...
     (some
      (lambda (u)
        (probe-file (make-pathname
                     ...
                     :name "abcl")))
      (java:jstatic "getURLs" (java::jclass "abcl.Lisp")  (system::boot-classloader))))
   (ignore-errors
      ...
      (some
       (lambda (u)
         (probe-file (make-pathname
                      :defaults (java:jcall "toString" u)
                      :name "abcl-contrib")))
       (java:jstatic "getURLs" (java::jclass "abcl.Lisp") (boot-classloader)))))
