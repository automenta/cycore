...
(let ((symbols (make-hash-table :test 'eq :size 2048)))
  (defun initialize-known-symbols (source ht)
    (let* ((source-class (java:jclass source))
           ...
           (symbol-class (java:jclass "abcl.Symbol"))
  ...
  (initialize-known-symbols "abcl.Symbol" symbols)
  (initialize-known-symbols "abcl.Keyword" symbols)
  (initialize-known-symbols "abcl.Lisp" symbols)
  (initialize-known-symbols "abcl.Nil" symbols)
