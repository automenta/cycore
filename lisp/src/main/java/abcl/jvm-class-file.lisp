...
(define-class-name +block-lisp-object+ "abcl.BlockLispObject")
(define-class-name +lisp-object+ "abcl.LispObject")
(defconstant +lisp-object-array+ (class-array +lisp-object+))
(define-class-name +lisp-simple-string+ "abcl.SimpleString")
(define-class-name +lisp+ "abcl.Lisp")
(define-class-name +lisp-nil+ "abcl.Nil")
(define-class-name +lisp-class+ "abcl.LispClass")
(define-class-name +lisp-symbol+ "abcl.Symbol")
(define-class-name +lisp-thread+ "abcl.LispThread")
(define-class-name +lisp-closure-binding+ "abcl.ClosureBinding")
(defconstant +closure-binding-array+ (class-array +lisp-closure-binding+))
(define-class-name +lisp-integer+ "abcl.LispInteger")
(define-class-name +lisp-fixnum+ "abcl.Fixnum")
(defconstant +lisp-fixnum-array+ (class-array +lisp-fixnum+))
(define-class-name +lisp-bignum+ "abcl.Bignum")
(define-class-name +lisp-single-float+ "abcl.SingleFloat")
(define-class-name +lisp-double-float+ "abcl.DoubleFloat")
(define-class-name +lisp-cons+ "abcl.Cons")
(define-class-name +lisp-load+ "abcl.Load")
(define-class-name +lisp-character+ "abcl.LispCharacter")
(defconstant +lisp-character-array+ (class-array +lisp-character+))
(define-class-name +lisp-structure-object+ "abcl.StructureObject")
(define-class-name +lisp-simple-vector+ "abcl.SimpleVector")
(define-class-name +lisp-abstract-string+ "abcl.AbstractString")
(define-class-name +lisp-abstract-vector+ "abcl.AbstractVector")
(define-class-name +lisp-abstract-bit-vector+
    "abcl.AbstractBitVector")
(define-class-name +lisp-environment+ "abcl.Environment")
(define-class-name +lisp-special-binding+ "abcl.SpecialBinding")
(define-class-name +lisp-special-bindings-mark+
    "abcl.SpecialBindingsMark")
(define-class-name +lisp-throw+ "abcl.Throw")
(define-class-name +lisp-return+ "abcl.Return")
(define-class-name +lisp-go+ "abcl.Go")
(define-class-name +lisp-primitive+ "abcl.Primitive")
(define-class-name +lisp-compiled-primitive+
    "abcl.CompiledPrimitive")
(define-class-name +lisp-eql-hash-table+ "abcl.EqlHashTable")
(define-class-name +lisp-hash-table+ "abcl.HashTable")
(define-class-name +lisp-package+ "abcl.Package")
(define-class-name +lisp-readtable+ "abcl.Readtable")
(define-class-name +lisp-stream+ "abcl.Stream")
(define-class-name +lisp-operator+ "abcl.Operator")
(define-class-name +lisp-closure+ "abcl.Closure")
(define-class-name +lisp-compiled-closure+ "abcl.CompiledClosure")
(define-class-name +argument-list-processor+
    "abcl.ArgumentListProcessor")
(define-class-name +alp-required-parameter+
    "abcl.ArgumentListProcessor$RequiredParam")
(define-class-name +alp-optional-parameter+
    "abcl.ArgumentListProcessor$OptionalParam")
(define-class-name +alp-keyword-parameter+
    "abcl.ArgumentListProcessor$KeywordParam")
