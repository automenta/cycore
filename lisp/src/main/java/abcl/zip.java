...
public final class zip extends Primitive
{
	...
	public LispObject execute(LispObject first, LispObject second)
    {
        ...
        if (second instanceof abcl.protocol.Hashtable) {
            return execute(zipfilePathname, (abcl.protocol.Hashtable)second);
        }
    ...
    public LispObject execute(final Pathname zipfilePathname, final abcl.protocol.Hashtable table) {
