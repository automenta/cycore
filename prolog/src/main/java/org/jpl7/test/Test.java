...
public class Test {
	...
	public static final boolean fieldInstanceBoolean1 = false;
	public static final boolean fieldInstanceBoolean2 = true;
	public byte fieldInstanceByte;
	public static final byte fieldInstanceByte1 = -(1 << 7);
	public static final byte fieldInstanceByte2 = -1;
	public static final byte fieldInstanceByte3 = 0;
	public static final byte fieldInstanceByte4 = 1;
	public static final byte fieldInstanceByte5 = (1 << 7) - 1;
	public char fieldInstanceChar;
	public static final char fieldInstanceChar1 = '\u0000';
	public static final char fieldInstanceChar2 = '\uFFFF';
	public double fieldInstanceDouble;
	public static final double fieldInstanceDouble1 = 12345.6789D;
	public static final double fieldInstanceDouble2 = 2.3456789e+100D;
	public static final double fieldInstanceDouble3 = 3.456789e-100D;
	public static final double fieldInstanceDouble4 = 0.0D;
	...
	public static final float fieldInstanceFloat1 = 12345.6789F;
	public static final float fieldInstanceFloat2 = 3.4e+38F;
	public static final float fieldInstanceFloat3 = 1.4e-45F;
	public static final float fieldInstanceFloat4 = 0.0F;
	...
	public static final int fieldInstanceInt1 = -(1 << 31);
	public static final int fieldInstanceInt2 = -(1 << 15);
	public static final int fieldInstanceInt3 = -(1 << 7);
	public static final int fieldInstanceInt4 = -1;
	public static final int fieldInstanceInt5 = 0;
	public static final int fieldInstanceInt6 = 1;
	public static final int fieldInstanceInt7 = (1 << 7) - 1;
	public static final int fieldInstanceInt8 = (1 << 15) - 1;
	public static final int fieldInstanceInt9 = (1 << 31) - 1;
	public long fieldInstanceLong;
	public static final long fieldInstanceLong1 = -(1 << 63);
	public static final long fieldInstanceLong10 = (1 << 31) - 1;
	public static final long fieldInstanceLong11 = (1 << 63) - 1;
	public static final long fieldInstanceLong2 = -(1 << 31);
	public static final long fieldInstanceLong3 = -(1 << 15);
	public static final long fieldInstanceLong4 = -(1 << 7);
	public static final long fieldInstanceLong5 = -1;
	public static final long fieldInstanceLong6 = 0;
	public static final long fieldInstanceLong7 = 1;
	public static final long fieldInstanceLong8 = (1 << 7) - 1;
	public static final long fieldInstanceLong9 = (1 << 15) - 1;
	public short fieldInstanceShort;
	public static final short fieldInstanceShort1 = -(1 << 15);
	public static final short fieldInstanceShort2 = -(1 << 7);
	public static final short fieldInstanceShort3 = -1;
	public static final short fieldInstanceShort4 = 0;
	public static final short fieldInstanceShort5 = 1;
	public static final short fieldInstanceShort6 = (1 << 7) - 1;
	public static final short fieldInstanceShort7 = (1 << 15) - 1;
	...
	public static Term wrapTerm(Term in) { // for dmiles 11/Jul/2008
		return new Compound("javaWrap", in);
	}
}
